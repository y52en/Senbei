...
mod tests {
    ...
    #[test]
    fn append_load_segment_relocates_program_headers_when_no_slack() {
        ...
        assert_eq!(updated.program_header_offset, 0x80);
        assert_eq!(updated.program_header_count, 1);
        assert_eq!(&output[0x20..0x28], &0x80_u64.to_le_bytes());
        assert_eq!(&output[0x80..0x84], &PT_LOAD.to_le_bytes());
        assert_eq!(&output[0x38..0x3a], &1_u16.to_le_bytes());
    }
